...
SenderWidget::SenderWidget(QWidget *parent,quint16 aimPort,quint16 myPort,QHostAddress aimIP) :
    QWidget(parent),
    ui(new Ui::SenderWidget)
{
    ...
    ui->ipLineEdit->setText(aimIP.toString());
//    ui->portLineEdit->setText(aimPort);
    ui->MssButton->setVisible(false);
    filereceived = 0;
    filePerSec = 0;

    udpsender = new Sender(this);
    udpsender->initSocket(myPort);
//    udpsender.getIpAddress(QHostAddress(aimIP),aimPort);
    connect(this,SIGNAL(setFileName(const QString&)),udpsender,SLOT(getFileName(const QString&)));
    connect(this,SIGNAL(setUdpAddress(QHostAddress,quint16)),udpsender,SLOT(getIpAddress(QHostAddress,quint16)));//TODO
...
void SenderWidget::on_fileButton_clicked()
{
...
void SenderWidget::on_portButton_clicked()
{
...
void SenderWidget::on_MssButton_clicked()
{
    udpsender->MssLen = ui->spinBox->value();
}

void SenderWidget::updateProgressBar()
{
...
void SenderWidget::setProgressBarMax(quint64 size)
{
...
void Sender::initSocket(quint16 myPort)
{
